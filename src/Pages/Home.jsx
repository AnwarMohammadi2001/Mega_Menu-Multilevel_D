...
const Home = () => {
  return (
    <div className="bg-gray-100">
      {/* Hero Section */}
      <section className="bg-cover bg-center h-[80vh] flex items-center justify-center text-center relative" style={{ backgroundImage: `url('/path-to-hero-image.jpg')` }}>
        <div className="absolute inset-0 bg-black bg-opacity-50"></div>
        <div className="z-10 text-white px-6 max-w-2xl">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Discover Your Style
          </h1>
          <p className="text-lg md:text-xl mb-8">
            Explore our exclusive collections for men, women, and kids. Trendy, stylish, and perfect for every season!
          </p>
          <Link
            to="/shop"
